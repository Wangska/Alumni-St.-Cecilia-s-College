...
<style>
.thread-card { background: white; border-radius: 16px; box-shadow: 0 4px 20px rgba(0,0,0,0.1); overflow: hidden; }
.thread-header { background: linear-gradient(135deg, #8b5cf6, #7c3aed); color: white; padding: 24px; }
.thread-body { padding: 20px; }
.meta { color: rgba(255,255,255,0.9); font-size: 14px; }
.comments { background: #f8f9fa; border-top: 1px solid #eef1f5; }
.comment-item { padding: 16px 20px; border-bottom: 1px solid #eef1f5; display: grid; grid-template-columns: 1fr 200px; gap: 16px; }
.comment-item:last-child { border-bottom: none; }
.comment-text { color: #374151; line-height: 1.6; }
.comment-side { color: #6b7280; font-size: 13px; }
@media (max-width: 768px) { .comment-item { grid-template-columns: 1fr; } }

/* Capstone-grade Back button */
.back-btn {
    display: inline-flex;
    align-items: center;
    gap: 8px;
...
/* Offset page content from sticky top bar */
.page-offset { padding-top: 16px; }
@media (max-width: 992px) { .page-offset { padding-top: 20px; } }
</style>

<div class="page-offset">
<div class="d-flex align-items-center justify-content-between mb-3">
    <h4 class="mb-0" style="font-weight:700; color:#2d3142;">View Topic</h4>
    <a href="/scratch/admin.php?page=forum" class="back-btn">
...
<div class="thread-card mb-4">
    <div class="thread-header">
        ...
        <div class="meta">
            <span><i class="fas fa-user me-1"></i><?= htmlspecialchars($topic['author_name'] ?? 'Admin') ?></span>
